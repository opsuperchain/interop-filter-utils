module github.com/opsuperchain/interop-filter-utils
...
// Use local monorepo for development - update this path or remove for production
replace github.com/ethereum-optimism/optimism => ../optimism/develop

// Use op-geth fork (same as monorepo)
